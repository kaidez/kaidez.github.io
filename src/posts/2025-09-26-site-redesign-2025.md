...
I installed both Anthropic's Claude tool and Augment's Cline as plugins into my <a href="https://code.visualstudio.com/">VS Code</a> setup. And to be honest, I'm not sure which I prefer at this time.

Claude can be used as a straight-forward CLI tool whereas Cline has its own sidebar UI like most VS Code plugins. I used both equally at the time of development and because I liked the feel of the CLI, I used Claude more often.

However, <a href="https://x.com/addyosmani">Google's Addy Osmani</a> made an excellent argument on <a href="https://addyo.substack.com/p/why-i-use-cline-for-ai-engineering">why Cline is the best tool for AI engineering</a>. Along with pro/con comparison list of the top AI tools, it makes a ton of awesome discussion points about developing with AI as a whole.
...
I discovered this article after I was done redoing my blog, so I never implemented the things Osmani was talking about. But I probably will sooner instead of later.
