...
This blog redesign features a clean, minimalist design built with the <a href="https://www.11ty.dev/">Eleventy (11ty) static site generator</a>. I also used <a href="https://claude.ai/">Claude AI</a> as a pair programming partner while coding, but <a href="https://cline.bot/">Cline AI</a> helped out a bit.
...
<ol>
  ...
  <li>
    <a href="#pair-programming">Pair Programming With AI Tools</a>
  </li>
  <li>
...
I also installed Cline as a plugin into VS Code setup. While Claude is a coding agent, Cline is a bot that allows you to use tool that allows you to use multiple coding agents.
...
I discovered this article after I was done redoing my blog, so I never implemented the Cline things Osmani was talking about. But I probably will sooner instead of later.

<h2 id="pair-programming">Pair Programming With AI Tools</h2>

But it's how the AI tools are used that's important and not the tools themselves. And in this case, I was thoroughly impressed!!!

I used it for the following tasks:

<ul>
  <li>
    <strong>JavaScript Unit Tests:</strong> Simply put: Claude is too good at this. I wrote a prompt to review
  </li>
</ul>
