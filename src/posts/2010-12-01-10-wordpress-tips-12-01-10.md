---
title: 10 WordPress Tips For Web Designers - ARCHIVE
date: 2010-12-10
excerpt: 10 great tips that can help you with WordPress development, customization and security.
...
---
When I wrote this post, it marked the third time that I hacked a WordPress theme to meet my design needs. I learned something new each time and applied all that I learned to future WP projects. Here are ten things I learned, mostly centered around customizing WordPress:
...
<img src="/assets/img/wordpress-logo.png" alt="WordPress logo" class="logo-pic" />
...
A quality plugin is one that's updated often enough so that it keeps up with the most recent version and build of WordPress. When you review a new plugin either on the Plugins screen of your WP Dashboard or over at [the wordpress.org Extend section][5], you'll see this info. If a plugin was updated 60 days or less from the day you found it, you know that the developer is diligently keeping their code in sync with the WordPress update cycle, and will probably continue to do so…this is a quality plugin.
 ...
 [5]: https://wordpress.org/search/extend
...
## 6. You *Have* To Know CSS Beyond Changing Typeface
