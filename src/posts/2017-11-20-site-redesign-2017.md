...
tags: ["personal"]
secondary_tags: ["javascript", "css", "jekyll"]
category: Personal
schema_type: "TechArticle"
dependencies: "JavaScript, CSS, Jekyll"
...
This speed and ease cascades down to my workflow. First, I do my updates on a <a href="https://github.com/kaidez/kaidez.github.io/tree/dev-branch">development branch</a> that runs on Jekyll's local web server, making things browser-accessible. (<em>Author's note: whatever's on the current build on the dev branch is completely different from what it as at the time this article was published.</em>)
...
<em>(Note: Rebecca Murphey has <a href="https://rmurphey.com/posts/building-for-http2/">an excellent post about HTTP/2</a> if you're unfamiliar with it.)</em>
...
Feel free to <a href="https://github.com/kaidez/kaidez.github.io/tree/2017-site">check out the blog's codebase on GitHub</a>: you may like <a href="https://github.com/kaidez/kaidez.github.io/tree/2017-site/js-build">the React stuff</a>. But things are pretty simple overall, and I'm A-OK with this.