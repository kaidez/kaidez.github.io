...
So the next step for us self-taught developers to embrace traditional computer science concepts. I went through <a href="https://www.youtube.com/watch?v=mEaI9LXqYlA">this MIT Intro to computer science course</a> using Python and liked it, but you should take some time and search for other courses.
