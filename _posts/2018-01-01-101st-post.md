...
Having the be-cool attitude does push you to learn new things and that's needed. But I needed to be practical at some point and realize that current  tools I was using worked fine, and that I shouldn't be in a rush to use the new stuff.

This dominated my thinking throughout 2017. It started as I was searching for a new job, realizing how important specific JavaScript framework and library knowledge was to potential employers.

It was further compounded when I spoke to relatively new developers who said that they didn't need those frameworks and libraries, implying they were pointless. A lot of them

And there seems to be a current trend in JS tooling where
