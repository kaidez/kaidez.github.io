...
The article discussed using multiple web development tools, not a single web dev tool like Visual Studio. Many of the tools and techniques were command line-powered: Git and its basic tasks, using Bash and aliasing commands, knowing testing tools, CSS preprocessers, template engines, etc.
