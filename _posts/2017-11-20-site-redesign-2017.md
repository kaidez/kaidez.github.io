...
<ol>
  ...
  <li class="post__list-item"><a href="#react">Two React Components</a></li>
...
<a name="bem-css"></a>
<h2>BEM CSS</h2>
I've been focusing on the component-based CSS design patterns like <a href="https://github.com/stubbornella/oocss/wiki">OOCSS</a>, <a href="https://suitcss.github.io/">SUITCSS</a> and <a href="http://vanseodesign.com/css/smacss-introduction/">SMACCS</a>. The one I love most is <a href="http://getbem.com/">BEM (Block Element Modifier)</a>.

BEM pretty much follows the OOCSS way of doing things but with a stricter naming convention. It's a <em>de facto</em> industry standard now so I implemented it for practice.

<a name="react"></a>
<h2>Two React Components</h2>
