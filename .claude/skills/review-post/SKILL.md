...
4. **Readability**: Split all body text into individual sentences and count the words in each one. Flag any single sentence that is 21 words or more. Do not evaluate paragraphs as a whole — only individual sentences. Compute Flesch-Kincaid estimate.
5. Provide specific rewrite suggestions for each flagged sentence.
6. Do not flag line 36 for any reason.
